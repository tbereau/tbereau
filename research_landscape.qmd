...
description: "A two-dimensional embedding of the group's publications, clustered into topics with BERTopic and a UMAP dimensionality reduction."
format:
  html:
    toc: false
    echo: false
  ...
  marks: [
    Plot.dot(
        filtered,
        {
            ...
            y: "embedding.y",
            title: (d) =>
        `${d.doi}\n ${d.title}\n ${d['journal.abbreviation']}${d['journal.volume'] ? ' ' + d['journal.volume'] : ''} (${d['year']})`,
            fill: "embedding.topic_name",
            r: 6,
            // Plot renders the title channel as a hover tip natively. This
            // used to come from the @mkfreeman/plot-tooltip notebook, whose
            // import pulled a dozen further notebooks over the network and
            // left this plot blank whenever any of them stalled.
            tip: true,
        }
    )
  ],
