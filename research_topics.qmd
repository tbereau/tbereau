...
pathway with a neural network, removing the need to simulate a ladder of
intermediate states: on Lennard-Jones excess chemical potentials it reaches an
MAE $\approx 0.15\,k_\mathrm{B}T$ in roughly 30 minutes, about an order of
magnitude faster than umbrella sampling at comparable accuracy. The
construction extends to solvation, where both end states are non-trivial, by
geodesic interpolation between their samples. Fokker--Planck score learning
