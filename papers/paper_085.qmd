...
date-format: iso
authors: "Hummerich, Bereau, Köthe"
description: "_AISTATS_ **267** (2026)"
year: 2026
format:
  html:
    toc: false
...
```
```{=html}
<footer class="blockquote-footer">from <cite title="Source Title">this site</cite>
</footer>
```
...
<a class="btn btn-outline-primary" href="http://arxiv.org/abs/2511.01464" role="button">
...
<a class="btn btn-outline-primary" href="https://arxiv.org/pdf/2511.01464" role="button">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
