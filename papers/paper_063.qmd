...
date: "2021-09-24 16:44:23"
date-format: iso
authors: "Mondal, Cazade, Das, Bereau, Meuwly"
description: "_J. Phys. Chem. B_ **125** (2021)"
year: 2021
format:
  html:
    toc: false
...
<div class="float-end">
    ...
    data-badge-popover='left' data-doi="10.1021/acs.jpcb.1c05423"></div>
</div>
...
```{bibtex}
@article{Mondal_2021, title={Multipolar Force Fields for Amide-I Spectroscopy from Conformational Dynamics of the Alanine Trimer}, volume={125}, ISSN={1520-5207}, url={http://dx.doi.org/10.1021/acs.jpcb.1c05423}, DOI={10.1021/acs.jpcb.1c05423}, number={39}, journal={The Journal of Physical Chemistry B}, publisher={American Chemical Society (ACS)}, author={Mondal, Padmabati and Cazade, Pierre-André and Das, Akshaya K. and Bereau, Tristan and Meuwly, Markus}, year={2021}, month=Sept, pages={10928–10938} }
```
```{=html}
...
<a class="btn btn-outline-primary" href="https://doi.org/10.1021/acs.jpcb.1c05423" role="button">
...
<a class="btn btn-outline-primary" href="https://arxiv.org/pdf/2106.10142" role="button">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
