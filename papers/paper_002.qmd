...
date: "2010-09-07 20:34:41"
date-format: iso
authors: "Bereau, Bachmann, Deserno"
description: "_J. Am. Chem. Soc._ **132** (2010)"
year: 2010
format:
  html:
    toc: false
...
<div class="float-end">
    ...
    data-badge-popover='left' data-doi="10.1021/ja105206w"></div>
</div>
...
It is found that it is the interplay between secondary structure and the loss of non-native tertiary contacts that determines the nature of the transition.
```{=html}
<footer class="blockquote-footer">from <cite title="Source Title">Semantic Scholar</cite>
</footer>
```
...
```{bibtex}
@article{Bereau_2010, title={Interplay between Secondary and Tertiary Structure Formation in Protein Folding Cooperativity}, volume={132}, ISSN={1520-5126}, url={http://dx.doi.org/10.1021/ja105206w}, DOI={10.1021/ja105206w}, number={38}, journal={Journal of the American Chemical Society}, publisher={American Chemical Society (ACS)}, author={Bereau, Tristan and Bachmann, Michael and Deserno, Markus}, year={2010}, month=Sept, pages={13129–13131} }
```
```{=html}
...
<a class="btn btn-outline-primary" href="https://doi.org/10.1021/ja105206w" role="button">
...
<a class="btn btn-outline-primary" href="https://pubs.acs.org/doi/pdf/10.1021/ja105206w?ref=article_openPDF" role="button">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
