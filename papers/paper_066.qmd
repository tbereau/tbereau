...
---
title: "CLiB – a novel cardiolipin-binder isolated <i>via</i> data-driven and <i>in vitro</i> screening"
doi: "10.1039/D2CB00125J"
date: "2022-06-10 07:21:17"
date-format: iso
authors: "Kleinwächter, Mohr, Joppe, Hellmann, Bereau, Osiewacz, Schneider"
description: "_RSC Chem. Biol._ **3** (2022)"
year: 2022
format:
  html:
    toc: false
...
<div class="float-end">
    ...
    data-badge-popover='left' data-doi="10.1039/D2CB00125J"></div>
</div>
...
The membrane binding properties of the 22 most promising molecules identified in the in silico approach were screened in vitro, using model membrane systems finally resulting in the identification of a single molecule, CLiB (CardioLipin-Binder).
```{=html}
<footer class="blockquote-footer">from <cite title="Source Title">Semantic Scholar</cite>
</footer>
```
...
```{bibtex}
@article{Kleinw_chter_2022, title={CLiB – a novel cardiolipin-binder isolated
                    <i>via</i>
                    data-driven and
                    <i>in vitro</i>
                    screening}, volume={3}, ISSN={2633-0679}, url={http://dx.doi.org/10.1039/D2CB00125J}, DOI={10.1039/d2cb00125j}, number={7}, journal={RSC Chemical Biology}, publisher={Royal Society of Chemistry (RSC)}, author={Kleinwächter, Isabel and Mohr, Bernadette and Joppe, Aljoscha and Hellmann, Nadja and Bereau, Tristan and Osiewacz, Heinz D. and Schneider, Dirk}, year={2022}, pages={941–954} }
```
```{=html}
...
<a class="btn btn-outline-primary" href="https://doi.org/10.1039/d2cb00125j" role="button">
...
<a class="btn btn-outline-primary" href="https://pubs.rsc.org/en/content/articlepdf/2022/cb/d2cb00125j" role="button">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
