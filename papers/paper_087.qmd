...
---
title: "NOMAD Utility Workflows"
doi: "10.5281/zenodo.14895189"
date: "2026-06-28 00:00:00"
date-format: iso
authors: "Rudzinski, Albino, Bereau, Daelman, Ladines, Mohr, Jesper, Walter"
description: "_Zenodo_ (2026)"
year: 2026
format:
  html:
    toc: false
...
`nomad-utility-workflows` is a utilities module for interfacing with the NOMAD software (https://zenodo.org/doi/10.5281/zenodo.8366162) within workflows, e.g., via a workflow manager, including python API functions for uploading to NOMAD and querying the repository as well as automated generation of NOMAD custom workflow yaml files.
```{=html}
...
```{bibtex}
@misc{https://doi.org/10.5281/zenodo.14895189,
  doi = {10.5281/ZENODO.14895189},
  url = {https://zenodo.org/doi/10.5281/zenodo.14895189},
  author = {Rudzinski, Joseph F. and Albino, Andrea and Bereau, Tristan and Daelman, Nathan and Ladines, Alvin N. and Mohr, Bernadette and Pedersen, Jesper and Walter, Luis J.},
  title = {NOMAD Utility Workflows},
  publisher = {Zenodo},
  year = {2026},
...
<a class="btn btn-outline-primary" href="https://doi.org/10.5281/zenodo.14895189" role="button">
