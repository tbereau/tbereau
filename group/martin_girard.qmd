...
about:
  ...
  links:
    ...
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0003-2051-6218
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Martin Girard")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Martin Girard"
            }
        )
    )
)
