...
---
title: "Yasemin Bozkurt Varolgunes"
description: "Former visiting PhD student in Tristan Bereau's group at the Institute for Theoretical Physics, Heidelberg University."
format:
  html:
    echo: false
    keep-hidden: true
...
about:
  ...
  links:
    ...
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0002-9179-2458
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Yasemin Bozkurt Varolgunes")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Yasemin Bozkurt Varolgunes"
            }
        )
    )
)
