...
description: "Tristan heads the group. Besides from science and data, he enjoys spending time outside and playing jazz piano."
format:
  html:
    echo: false
    keep-hidden: true
...
about:
  ...
  links:
    ...
    - icon: github
      text: Github
      href: https://github.com/tbereau
    - icon: google
      text: Google Scholar
      href: https://scholar.google.com/citations?user=9cYdrBUAAAAJ
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0001-9945-1271
---
