...
about:
  ...
  links:
    ...
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0002-0518-609X
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Atreyee Banerjee")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Atreyee Banerjee"
            }
        )
    )
)
