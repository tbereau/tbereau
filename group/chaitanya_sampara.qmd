...
---
title: "Chaitanya Sampara"
description: "Master student in Tristan Bereau's group at the Institute for Theoretical Physics, Heidelberg University."
format:
  html:
    echo: false
    keep-hidden: true
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Chaitanya Sampara")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Chaitanya Sampara"
            }
        )
    )
)
