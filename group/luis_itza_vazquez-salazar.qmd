...
description: "Postdoc in Tristan Bereau's group at the Institute for Theoretical Physics, Heidelberg University."
format:
  html:
    echo: false
    keep-hidden: true
...
about:
  ...
  links:
    ...
    - icon: house
      text: Website
      href: https://livazquezs.github.io/
    - icon: google
      text: Google Scholar
      href: https://scholar.google.com/citations?user=IY9bJXIAAAAJ&hl=en
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0001-6347-5108
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Luis Itza Vazquez-Salazar")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Luis Itza Vazquez-Salazar"
            }
        )
    )
)
