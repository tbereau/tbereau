...
about:
  ...
  links:
    ...
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0009-0000-0113-6215
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Luis J. Walter")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Luis J. Walter"
            }
        )
    )
)
