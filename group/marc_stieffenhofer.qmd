...
---
title: "Marc Stieffenhofer"
description: "Former PhD student in Tristan Bereau's group at the Institute for Theoretical Physics, Heidelberg University."
format:
  html:
    echo: false
    keep-hidden: true
categories:
  - alumnus
  - phd student
image: ../static/stieffenhofer.jpg
about:
  id: hero-heading
  template: solana
  image: ../static/stieffenhofer.jpg
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Marc Stieffenhofer")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Marc Stieffenhofer"
            }
        )
    )
)
