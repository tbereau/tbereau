...
---
title: "Daniel Nagel"
description: "Former postdoc in Tristan Bereau's group at the Institute for Theoretical Physics, Heidelberg University."
format:
  html:
    echo: false
    keep-hidden: true
...
about:
  ...
  links:
    ...
    - icon: github
      text: Github
      href: https://github.com/braniii
    - icon: house
      text: Website
      href: https://braniii.github.io/
    - icon: google
      text: Google Scholar
      href: https://scholar.google.com/citations?user=3Pz_4wwAAAAJ
    - icon: orcid
      text: ORCID
      href: https://orcid.org/0000-0002-2863-2646
---
...
Postdoc, Uni. Heidelberg | 2023 - 2026

PhD [@stocklab](https://www.moldyn.uni-freiburg.de/), ALU Freiburg | 2018 - 2023
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Daniel Nagel"
            }
        )
    )
)
