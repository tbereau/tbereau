...
about:
  ...
  links:
    ...
    - icon: github
      text: Github
      href: https://github.com/alekepd
    - icon: google
      text: Google Scholar
      href: https://scholar.google.com/citations?user=tqFHh3gAAAAJ&hl=en
---
...
my_papers = papers.filter(function(p) {
    return p.authors.map(a => a.full_name).includes("Aleksander Durumeric")
})
```
...
collaborators = Array.from(
    new Set(
        ...
        .filter(function(a) {
            return a.full_name != "Aleksander Durumeric"
            }
        )
    )
)
